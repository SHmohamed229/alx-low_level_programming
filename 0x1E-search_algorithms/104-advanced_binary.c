...
/**
 * print_array - this method for Print the array of ints, separated with commas
 *
...
/**
 * binary_rec - this method searche for a value in an array of integers recursively
 *
 * @array: this pointer to the first element of the array to search in
 * @first: this minimum index of the array
 * @last: this maximum index of the array
...
/**
 * advanced_binary - this method searche for a value in an array of integers
 *
 * @array: this  pointer to the first element of the array to search in
